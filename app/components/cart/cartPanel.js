  ...
  return (
    <section className="w-full flex flex-col border-2 border-amber-400">
      <div className="w-full flex flex-row justify-end p-2">
        <button
          className="bg-amber-400 text-white py-1 px-3 rounded hover:scale-105 duration-200 hover:text-gray-500"
          onClick={() => setShowTickets(!showTickets)}
        >
          {showTickets ? 'Ver Carrito' : 'Ver Tickets'}
        </button>
      </div>
      <div className="w-full flex flex-col md:flex-row border-2 border-amber-400">
        <div className="w-full md:w-44 flex flex-col justify-center items-center md:border-r-2 border-amber-400">
